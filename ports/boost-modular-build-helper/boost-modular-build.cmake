function(boost_modular_build)
    ...
    message( ${VCPKG_CMAKE_SYSTEM_NAME} )
    message( ${VCPKG_TARGET_ARCHITECTURE} )
    message( ${CURRENT_INSTALLED_DIR} )
    ...
    elseif(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "iOS" AND VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
